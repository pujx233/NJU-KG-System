    ...
    <div class="login_box">
      ...
      <el-form ref="loginForm" :rules="loginRules" :model="loginForm" size="mini">
        ...
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" placeholder="新密码" show-password  prefix-icon="iconfont icon-3702mima"></el-input>
        </el-form-item>

        <el-form-item prop="passwordAgain">
          <el-input v-model="loginForm.passwordAgain" placeholder="再次重复新密码" show-password  prefix-icon="iconfont icon-3702mima"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button   @click.native.prevent="handleResetPWD" type="primary">修改</el-button>
        </el-form-item>
  ...
  data () {
    ...
    return {
      ...
      loginRules: {
        ...
        passwordAgain: [
          { required: true, trigger: 'blur', message: '请再次重复新密码' }
        ],
  ...
  methods: {
    ...
    handleResetPWD () {
      ...
      if (this.loginForm.password!==this.loginForm.passwordAgain){
        ...
        updateUserAPI(this.loginForm).then(res => {
          console.log(res)
          if (res.data.success) {
